...
| **exemptVolume** | **kotlin.Double** | Portion of short volume that was marked as exempt from regulation SHO. |  [optional] |
...
| **nonExemptVolume** | **kotlin.Double** | Portion of short volume that was not exempt from regulation SHO (i.e., short_volume - exempt_volume). |  [optional] |
...
| **shortVolume** | **kotlin.Double** | Total number of shares sold short across all venues for the ticker on the given date. |  [optional] |
...
| **totalVolume** | **kotlin.Double** | Total reported volume across all venues for the ticker on the given date. |  [optional] |
