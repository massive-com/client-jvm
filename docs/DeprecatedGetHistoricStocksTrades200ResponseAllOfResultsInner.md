...
# DeprecatedGetHistoricStocksTrades200ResponseAllOfResultsInner
...
| **e** | **kotlin.Int** | The trade correction indicator.  |  |
...
| **r** | **kotlin.Int** | The ID for the Trade Reporting Facility where the trade took place.  |  |
