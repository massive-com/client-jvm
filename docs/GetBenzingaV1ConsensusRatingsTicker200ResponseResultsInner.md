...
# GetBenzingaV1ConsensusRatingsTicker200ResponseResultsInner
...
| **highPriceTarget** | **kotlin.Double** | The highest price target among all contributing analysts. |  [optional] |
| **lowPriceTarget** | **kotlin.Double** | The lowest price target among all contributing analysts. |  [optional] |
