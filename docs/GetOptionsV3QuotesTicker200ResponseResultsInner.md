...
| **askExchange** | **kotlin.Int** | The exchange ID reporting the ask side of the quote. |  [optional] |
| **askSize** | **kotlin.Long** | The size available at the ask price. |  [optional] |
| **bidExchange** | **kotlin.Int** | The exchange ID reporting the bid side of the quote. |  [optional] |
| **bidSize** | **kotlin.Long** | The size available at the bid price. |  [optional] |
