...
| **dollarVolume** | **kotlin.Double** | The total dollar volume of the transactions that occurred within the timeframe. |  |
...
| **settlementPrice** | **kotlin.Double** | The price the contract would have cost to settle for this session. |  [optional] |
