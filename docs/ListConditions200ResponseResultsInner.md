...
| **id** | **kotlin.Int** | An identifier used by Polygon.io for this condition. Unique per data type. |  |
...
| **exchange** | **kotlin.Int** | If present, mapping this condition from a Polygon.io code to a SIP symbol depends on this attribute. In other words, data with this condition attached comes exclusively from the given exchange. |  [optional] |
