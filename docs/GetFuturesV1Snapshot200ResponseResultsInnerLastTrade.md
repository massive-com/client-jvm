...
# GetFuturesV1Snapshot200ResponseResultsInnerLastTrade

## Properties
| Name | Type | Description | Notes |
| ------------ | ------------- | ------------- | ------------- |
| **lastUpdated** | **kotlin.Long** | The time when the trade was generated at the exchange to nanosecond precision. |  [optional] |
