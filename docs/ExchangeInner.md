...
| ------------ | ------------- | ------------- | ------------- |
| **code** | **kotlin.String** | A unique identifier for the exchange internal to Massive.  This is not an industry code or ISO standard. |  [optional] |
...
| **tape** | **kotlin.String** | The tape id of the exchange. |  [optional] |
| **type** | **kotlin.String** | The type of exchange. - TRF &#x3D; Trade Reporting Facility - exchange &#x3D; Reporting exchange on the tape  |  [optional] |
