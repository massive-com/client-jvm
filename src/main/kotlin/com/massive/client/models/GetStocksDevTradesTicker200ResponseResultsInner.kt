 ...
 * @param sizeFraction The fractional size of a trade (also known as volume).
...
data class GetStocksDevTradesTicker200ResponseResultsInner (
    ...
    @Json(name = "size_fraction")
    val sizeFraction: kotlin.Long,
    ...
    val correction: kotlin.Long? = null,
