...
class GetOptionsChain200ResponseResultsInnerLastTradeTest : ShouldSpec() {
    init {
        ...
        // to test the property `exchange` - The exchange ID. See <a href=\"https://massive.com/docs/rest/options/market-operations/exchanges\" alt=\"Exchanges\">Exchanges</a> for Massive.com's mapping of exchange IDs.
