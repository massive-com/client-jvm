...
class CryptoLastTradeLastTest : ShouldSpec() {
    init {
        ...
        // to test the property `exchange` - The exchange that this crypto trade happened on.   See <a href=\"https://polygon.io/docs/crypto/get_v3_reference_exchanges\">Exchanges</a> for a mapping of exchanges to IDs. 
