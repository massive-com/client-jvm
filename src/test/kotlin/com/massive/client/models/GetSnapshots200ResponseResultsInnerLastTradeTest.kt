...
class GetSnapshots200ResponseResultsInnerLastTradeTest : ShouldSpec() {
    init {
        ...
        // to test the property `decimalSize` - The size of a trade, including fractional shares, represented as a decimal string where the fractional part is expressed in millionths. This field is only returned for stocks snapshots.
