...
import com.massive.client.models.GetStocksDevTradesTicker200ResponseResultsInner

class GetStocksDevTradesTicker200ResponseResultsInnerTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetStocksDevTradesTicker200ResponseResultsInner
        //val modelInstance = GetStocksDevTradesTicker200ResponseResultsInner()
        ...
        // to test the property `sizeFraction` - The fractional size of a trade (also known as volume).
        should("test sizeFraction") {
            // uncomment below to test the property
            //modelInstance.sizeFraction shouldBe ("TODO")
        }

        // to test the property `ticker` - The ticker symbol.
        should("test ticker") {
            // uncomment below to test the property
